...
public final class Nxt {
    ...
    static {
        ...
        try (InputStream is = ClassLoader.getSystemResourceAsStream("ntx-default.properties")) {
            if (is != null) {
                ...
                String configFile = System.getProperty("ntx-default.properties");
                if (configFile != null) {
                    try (InputStream fis = new FileInputStream(configFile)) {
                        Nxt.defaultProperties.load(fis);
                    } catch (IOException e) {
                        throw new RuntimeException("Error loading ntx-default.properties from " + configFile);
                    }
                } else {
                    throw new RuntimeException("ntx-default.properties not in classpath and system property ntx-default.properties not defined either");
                }
            }
        } catch (IOException e) {
            throw new RuntimeException("Error loading ntx-default.properties", e);
        }
    }
    ...
    private static class Init {
        ...
        static {
            ...
            Logger.logMessage("NTX server " + VERSION + " started successfully.");
